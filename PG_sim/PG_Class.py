...
class PolGrad:
    ...
    def create_model(self):
        ...
        f = Dense(256, activation = 'sigmoid', kernel_initializer='glorot_uniform')(x)
        f = Dense(128, activation = 'sigmoid', kernel_initializer='glorot_uniform')(f)
        f = Dense(64, activation = 'sigmoid', kernel_initializer='glorot_uniform')(f)
        f = Dense(16, activation = 'sigmoid', kernel_initializer='glorot_uniform')(f)
        f = Dense(8, activation = 'sigmoid', kernel_initializer='glorot_uniform')(f)
    ...
    def train_target(self, states, actions, discounted_episode_rewards, allowed_actions):
        n = 0
        ...
        # allowed_act_prob[allowed_act_prob == 0.0] = 3.0 
